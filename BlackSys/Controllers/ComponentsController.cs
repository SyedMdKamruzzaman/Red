...
namespace BlackSys.Controllers
{
    public class ComponentsController : Controller
    {
        ...
        {
            var component = db.Component.Include(c => c.ComponentCategory).Include(c => c.Customer);
        ...
        public ActionResult Create([Bind(Include = "ComponentID,Code,Description,ComponentCategoryID,CustomerID,CustomerCode,CountryOfOrigin,Description2,PurchasingPrice,PurchasingTerms,ListPrice,HtsID,SacID,IsActive,DiscontinuedDate,CreationDate,CreatedBy,ModifiedDate,ModifiedBy,rowguid")] Component component)
        {
