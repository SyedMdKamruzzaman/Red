...
namespace BlackSys.Controllers
{
    public class CardTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Type,DiscountPercentage,EntryBy,EntryDateTime,EntryByIp,UpdatedBy,UpdatedDateTime,UpdatedByIp")] CardType cardType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,Type,DiscountPercentage,EntryBy,EntryDateTime,EntryByIp,UpdatedBy,UpdatedDateTime,UpdatedByIp")] CardType cardType)
        {
            if (ModelState.IsValid)
            {
