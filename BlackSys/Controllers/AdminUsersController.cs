    ...
    public class AdminUsersController : Controller
    {
        ...
        public ActionResult Index(string Search)
        {
            ...
            else
            {
                ...
                errorMessage = "You must enter a value to search";
                ...
                if (adminresult.Succeeded)
                {
                    if (selectedRoles != null)
                    {
                        ...
                        if (!result.Succeeded)
                        {
                            ...
                            ViewBag.RoleId = new SelectList(await RoleManager.Roles.ToListAsync(), "Name", "Name");
                            ViewBag.Result = "The Registry was saved successfully !";
                            return View();
                        }
                    }
                }
        ...
        public async Task<ActionResult> Edit([Bind(Include = "Email,Id,Address,City,State,PostalCode, BranchId")] EditUserViewModel editUser, params string[] selectedRole)
        {
            if (ModelState.IsValid)
            {
