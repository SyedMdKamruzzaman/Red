...
namespace BlackSys.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //            //    {
        //            //        ViewBag.errorMessage = "Your Account hasn't been confirmed by the Administrator";
        //            //        return View("Error");
        //            //    }
        //            //}
        ...
        public void LoadMenu(string UserID)
        {
            ...
            IEnumerable<Menu> loadMenu = db.Database.SqlQuery<Menu>("SP_Load_Menu @UserID ='" + UserID + "'").ToList();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //    "Confirme su cuenta", 
                    //    "Por favor confirme su cuenta haciendo clic en este enlace: <a href=\"" 
                    //    + callbackUrl + "\">link</a>");
        ...
        public ActionResult ResetPassword()
        {
            ...
            ViewBag.Em = User.Identity.GetUserName();
            if (userId == null)
            {
                return RedirectToAction("Index", "Home");
            }
            return View();
            //return username == null ? View("Error") : View();
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            var iuser = User.Identity.GetUserName();
            var user = await UserManager.FindByEmailAsync(iuser.ToString());
            var generestoken = UserManager.GeneratePasswordResetToken(user.Id);
            if (user == null)
            {
                // Don't reveal that the user does not exist
                return RedirectToAction("ResetPasswordConfirmation", "Account");
            }
            var result = await UserManager.ResetPasswordAsync(user.Id, generestoken, model.Password);
            if (result.Succeeded)
            {
        ...
        //            {
        //                var profiledetails = (from data in db.Employees.AsEnumerable()
        ...
        //                                      join img in db.Files.AsEnumerable()
        //                                      on data.EmpID equals img.Id
        //                                      where (data.EmpEmail == iuser)
        //                                      select new Employee
        //                                      {
        //                                          EmpID = data.EmpID,
